...
import os
if helpdebug:
    print("classes about to load in")
...
print("variables done for most part")
...
if dlg.OK == False:
    print("dialogue was canceled I think")
...
while continueRoutine:
    ...
    if (defaultKeyboard.getKeys(keyList=["escape"]) and defaultKeyboard.getKeys(keyList=["right"])) or endExpNow:
        print("experiment ended by user, pressing escape + right arrow")
        core.quit()
        if eyetracker:
...
if eyetracker:
    eyetracker.setConnectionState(False)
print("program made it to the end of all lines of code, ending naturally")
